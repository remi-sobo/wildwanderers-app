  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-[calc(74px+env(safe-area-inset-bottom))] right-4 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-amber text-[#23170c] shadow-[0_12px_30px_rgba(120,68,16,0.34)] transition-transform hover:-translate-y-0.5 hover:bg-amber-deep focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber md:bottom-8 md:right-8"
      >
